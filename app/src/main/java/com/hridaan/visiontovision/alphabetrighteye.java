...
boolean hasfailedyet=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instructions=findViewById(R.id.infoo);
        alert1box();
        ...
        ImageView mic=findViewById(R.id.micbutton);
        abc.setTextSize(px);
                ...
                yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Log.i("run", "iterationCounter = "+String.valueOf(iterationCounter));
    ...
    public void alert1box(){
        Dialog dialog =new Dialog(alphabetrighteye.this);
